export class Professional
{
    ...
    constructor(name:string, age:number, genre:string, weight:number, height:number, hairColor:string, eyeColor:string, race:string, isRetired:boolean, nationality:string, oscarsNumber:number, profession:string[], bibliografia:string )
    {
        this.name=name;
        this.age=age;
        this.genre=genre;
    ...
    public setBibliografia(bibliografia:string)
    {
        this.bibliografia=bibliografia;
    }
    ...
    {
        console.log("This characteristics of Professional " + this.name + " are");
        ...
        console.log("-Bibliografia Completo:" + this.bibliografia + "\n");
